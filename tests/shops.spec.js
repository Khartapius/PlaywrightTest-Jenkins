...
test('Check all Hubtel Shops links excluding links with / or wrong format', async ({ page }) => {
    // Navigate to Hubtel Shops page
    await page.goto('https://explore.hubtel.com/service-shops/');
